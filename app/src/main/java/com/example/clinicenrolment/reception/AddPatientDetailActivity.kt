...
class AddPatientDetailActivity :AppCompatActivity() , View.OnClickListener
{
    ...
    private fun savePatientDetails() {
        ...
        if (Connectivity.isConnected(this))
        {
            if (globalErrorMessage.equals("")) {
                ...
                var patientData = PatientDetail("",patientId.toString(),patientName.toString(),
                    patientAge.toString(),patientMoNo.toString(),reason.toString(),date,false,false,"",false,false)
                ...
                var reasonData = Reason(reasonId.toString(),patientId,reason.toString(),date)
              ...
              var documentList:ArrayList<DocumentModel> = ArrayList()
              var documentBase = DocumentBase(documentList)

                val patientDetail = AddPateintModel(patientBase,medicineBase,reasonBase,documentBase)
